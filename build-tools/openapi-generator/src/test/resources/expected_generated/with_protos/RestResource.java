...
public interface RestResource {
  ...
  */
  ...
  TestApiProto.GetBody withInParam(
  ...
  */
  ...
  TestApiProto.GetBody withInRepeatedParam(
    @PathParam("id") String id);
  ...
  */
  @GET
  TestApiProto.ResponseContent list();

  /**
   * Test PUT and reference to response.
  */
  @PUT
  TestApiProto.ResponseContent put(
    TestApiProto.PostBody request);
