 ...
 * rail on filter condition to stop infinite loop issues.
 */
public final class EnhancedFilterJoinRuleV2 extends EnhancedFilterJoinRule {

  public static final EnhancedFilterJoinRule WITH_FILTER =
      new EnhancedFilterJoinRuleV2(
          Config.EMPTY
              .withDescription("EnhancedFilterJoinRuleV2:withFilter")
              .withOperandSupplier(
                  op ->
  ...
  public static final EnhancedFilterJoinRule NO_FILTER =
      new EnhancedFilterJoinRuleV2(
          Config.EMPTY
              .withDescription("EnhancedFilterJoinRuleV2:withoutFilter")
              .withOperandSupplier(op -> op.operand(Join.class).anyInputs())
              .as(RelRule.Config.class));

  private EnhancedFilterJoinRuleV2(Config config) {
    super(config);
  }
