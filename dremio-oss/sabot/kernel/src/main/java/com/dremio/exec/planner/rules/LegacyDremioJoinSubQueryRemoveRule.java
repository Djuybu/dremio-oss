 ...
 */
public class LegacyDremioJoinSubQueryRemoveRule
    extends RelRule<LegacyDremioJoinSubQueryRemoveRule.Config> {
   ...
   * @param config
   */
  protected LegacyDremioJoinSubQueryRemoveRule(Config config) {
    super(config);
  }
  ...
  public interface Config extends RelRule.Config {
    ...
    default RelOptRule toRule() {
      return new LegacyDremioJoinSubQueryRemoveRule(this);
    }
  }
