...
public class VersionedViewHandle implements VersionedDatasetHandle {
  private EntityPath viewPath;
  private IcebergViewMetadata icebergViewMetadata;
  private String id;
  private String uniqueId;

  private VersionedViewHandle(
  ...
  public static final class Builder {
    ...
    public VersionedViewHandle build() {
      Objects.requireNonNull(viewPath, "dataset path is required");
      return new VersionedViewHandle(viewPath, icebergViewMetadata, id, uniqueId);
    }
  }
}
