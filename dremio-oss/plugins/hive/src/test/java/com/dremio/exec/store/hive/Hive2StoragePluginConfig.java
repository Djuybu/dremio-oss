...
public class Hive2StoragePluginConfig extends HiveStoragePluginConfig {
  ...
  @Override
  public StoragePlugin newPlugin(PluginSabotContext pluginSabotContext, String name, Provider<StoragePluginId> pluginIdProvider) {
    ...
    return new Hive2PluginCreator().createStoragePlugin(manager, this, pluginSabotContext, name, pluginIdProvider);
  }
