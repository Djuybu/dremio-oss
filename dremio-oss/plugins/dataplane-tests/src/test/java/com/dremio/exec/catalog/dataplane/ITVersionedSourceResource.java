...
import static com.dremio.exec.catalog.CatalogOptions.DREMIO_CATALOG_STORAGE_URI_FOR_FOLDER;
...
public class ITVersionedSourceResource extends ITBaseTestVersioned {
  ...
  protected static AutoCloseable enableStorageUri() {
    return withSystemOption(DREMIO_CATALOG_STORAGE_URI_FOR_FOLDER, true);
  }

  protected static AutoCloseable disableStorageUri() {
    return withSystemOption(DREMIO_CATALOG_STORAGE_URI_FOR_FOLDER, false);
  }
